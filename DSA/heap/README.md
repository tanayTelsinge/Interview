...
### Why Use x² + y²?
The Euclidean distance between a point (x, y) and the origin (0,0) is sqrt(x²+y²).
Since sqrt is monotonically increasing, we can compare squared distances directly — no need to compute the square root.
...
## 4. Medium: Task Scheduler (LC 621) - Amazon, Google
...
## 5. Medium: Hands of Straights (LC 846) - Google, Amazon
